...
export default function DashboardLayout({ children }: Props) {
                            ...
                            <div className="ml-3 relative">
                                <div className="flex items-center">
                                    ...
                                    <Link
                                        ...
                                        method="post"
                                        as="button"
                                        className="group relative inline-flex items-center px-4 py-2 border-2 border-orange-500 rounded-lg font-medium text-orange-500 hover:text-white transition-all duration-300 hover:bg-orange-500 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:ring-offset-2"
                                        >
                                        <span className="absolute left-0 w-0 h-full bg-orange-500 transition-all duration-300 ease-in-out group-hover:w-full -z-1"></span>
                                        <svg 
  ...
  method="post"
  as="button"
  className="flex items-center gap-2 w-full text-left px-4 py-2 border border-orange-500 rounded-md text-orange-500 hover:bg-orange-500 hover:text-white transition duration-300"
>
  <svg
    className="w-5 h-5"
    fill="none"
