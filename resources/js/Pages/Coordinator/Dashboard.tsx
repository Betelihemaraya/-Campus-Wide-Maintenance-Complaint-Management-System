              ...
              <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-6">
                ...
                <div className="flex flex-col md:flex-row space-y-3 md:space-y-0 md:space-x-4">
                  ...
                  <div className="relative flex items-center">
                    ...
                    <input
                      type="text"
                      className="pl-10 pr-4 py-2 w-full border border-black rounded-md text-black placeholder-black focus:outline-none focus:ring-2 focus:ring-orange-500/20 focus:border-orange-500 transition duration-300"
                      placeholder="Search"
                      value={searchQuery}
                  ...
                  {/* Status Filter */}
                  <select
                    className="block w-full pl-3 pr-10 py-2 text-base border border-black rounded-md text-black focus:outline-none focus:ring-2 focus:ring-orange-500/20 focus:border-orange-500 transition duration-300"
                    value={statusFilter}
